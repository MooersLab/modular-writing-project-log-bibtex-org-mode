...
\newglossaryentry{aggregate pattern}{
    name = {aggregate pattern},
    description ={An Aggregate pattern can refer to concepts in either statistics or computer programming. Both uses deal with considering a large case as composed of smaller, simpler, pieces. Here is an example from Python: }
    }
